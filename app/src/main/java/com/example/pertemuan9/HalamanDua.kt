...
fun HalamanDua(
    ...
    var judulSkripi by remember { mutableStateOf("") }
    var listData: MutableList<String> = mutableListOf(namaMahasiswa, nim, konsentrasi,judulSkripi)
